...
public class SendEmoteListTest extends GameBaseCase {
    private SendEmoteList listener;
    ...
    public void setUp() throws Exception {
        ...
        listener = new SendEmoteList(gamePlayer(true));
    ...
    @Test
    void eventClass() {
        assertEquals(GameJoined.class, listener.event());
    }
